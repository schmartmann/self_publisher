...
async function printDocTitle(auth) {
  ...
  const doc = res.data;
  console.log(`The title of the document is: ${doc.title}`);
//   console.log({ dogKeys: Object.keys(doc)})
//   console.log({ docBody: doc.body})
  const content = doc.body.content
  const lastContent = content[content.length - 100];
